...
struct obs_output_info {
	...
	/*pause stream kind video audio both*/
	void (*pause)(void *data,const char * kind);
	void (*resume)(void *data,const char * kind);
	/*signal protocol to mediasoup*/
	void (*signal_protocol)(void *data,const char *method,const char* key,const char* value);
};
