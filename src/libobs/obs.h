...
// add cjf
EXPORT const char *obs_source_get_image_path(obs_source_t *source); 
EXPORT void obs_source_set_image_path(obs_source_t *source,const char *path);
EXPORT bool obs_source_get_take_effect(obs_source_t *source);
EXPORT void obs_source_set_take_effect(obs_source_t *source,bool effect);
EXPORT bool obs_source_get_change_path(obs_source_t *source);
EXPORT void obs_source_set_change_path(obs_source_t *source,bool change);
EXPORT bool obs_source_get_mosaic(obs_source_t *source);
EXPORT void obs_source_set_mosaic(obs_source_t *source,bool mosaic);
...
EXPORT void obs_source_save_image(int type, int width,
				  int height, int len, uint8_t *rgb,
	unsigned long start);
...
EXPORT void obs_source_process_settexture(gs_texture_t *sticke1,
...
EXPORT obs_sceneitem_t *obs_scene_select_find_source_not_match(obs_scene_t *scene,
					      const char *id);
...
EXPORT void obs_scene_enum_items(obs_scene_t *scene,
				 ...
				 void *param);
EXPORT void obs_scene_enum_items_select(obs_scene_t *scene, bool selected);
// add by cjf
typedef void (*select_left_widget_item_func)(obs_sceneitem_t *item, bool select);
EXPORT void obs_scene_enum_items_select_left_widget_item(obs_scene_t *scene, bool selected, select_left_widget_item_func func);
...
//add by huchenzhi
typedef void (*remove_left_widget_item_func)(obs_sceneitem_t *item);
EXPORT void obs_sceneitem_remove_left_widget(obs_sceneitem_t *item,
				 remove_left_widget_item_func func);
...
// add by cjf
EXPORT void obs_sceneitem_select_left_widget(obs_sceneitem_t *item, bool select, select_left_widget_item_func func);
...
// add by cjf 
typedef void (*obs_scene_atomic_update_later_func)(void *, obs_scene_t *scene, struct obs_sceneitem_crop *crop);
EXPORT obs_sceneitem_t *obs_scene_add_later(obs_scene_t *scene, obs_source_t *source, struct obs_sceneitem_crop *crop);
EXPORT void obs_scene_atomic_update_later(obs_scene_t *scene, obs_scene_atomic_update_later_func func, void *data, struct obs_sceneitem_crop *crop);
...
EXPORT bool obs_output_set_reconnect(const obs_output_t *output,bool reconnect);
...
EXPORT bool obs_output_stream_pause(obs_output_t *output, bool pause,const char *kind);
...
/** Returns the userid (if any) for this service context */
...
/* send unity model index */
EXPORT void obs_source_send_model_index(int index);
