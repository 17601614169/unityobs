...
try {
	...
	BPtr<char> updateFilePath =
		GetConfigPathPtr("yl-custom-service\\updates\\updater.exe");
...
try {
	...
	BPtr<char> manifestPath =
		GetConfigPathPtr("yl-custom-service\\updates\\manifest.json");
...
try {
	...
	BPtr<char> whatsnewPath =
		GetConfigPathPtr("yl-custom-service\\updates\\whatsnew.json");
